...
<h1 class="text-center text-primary">Administration du site</h1>

<h2 class="text-info mt-2">Liste des utilisateurs de la base </h2>

<?php
$users = listerUtilisateurs("nbl");
?>
<h3 class="text-secondary mt-2">Utilisateurs autorisés</h3>
...
<h3 class="text-secondary mt-2">Utilisateurs non autorisés</h3>
<table class="table table-hover">
    <thead>
    <tr>
        <th scope="col">Pseudo</th>
...
<h3 class="text-secondary mt-2">Changement de statut des utilisateurs</h3>
